...
class ScheduleController extends BaseController
{
    ...
    public function getPODetails()
    {
        ...
        $reqStartMc = 'http://192.168.1.3/CapacityApps/public/api/reqstartmc/' . $no_model;
    ...
    public function filterstatusbahanbaku()
    {
        ...
        if (!empty($model)) {
            $masterApi = 'http://192.168.1.3/CapacityApps/public/api/getStartMc/' . $model;
        ...
        $apiUrl = 'http://192.168.1.3/MaterialSystem/public/api/statusbahanbaku/?' . http_build_query($params);
