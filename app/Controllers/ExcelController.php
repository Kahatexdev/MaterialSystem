...
class ExcelController extends BaseController
{
    ...
    public function excelPPHNomodel($area, $model)
    {
        ...
        foreach ($models as $items) {
            ...
            $apiUrl  = 'http://172.23.39.117/CapacityApps/public/api/getDataPerinisial/' . $area . '/' . $model . '/' . $styleSize;
    ...
    {
        $apiUrl = 'http://172.23.39.117/CapacityApps/public/api/getPPhPerhari/' . $area . '/' . $tanggal;
    ...
    public function exportPoBenang()
    {
        ...
        foreach ($data as $index => $item) {
            ...
            $getStartMcUrl = 'http://172.23.39.117/CapacityApps/public/api/getStartMc/' . $model;
    ...
    public function exportGlobalReport()
    {
        ...
        $getDeliv = 'http://172.23.39.117/CapacityApps/public/api/getDeliv/' . $key;
    ...
    public function generateOpenPOExcel($no_model)
    {
        ...
        $apiUrl = 'http://172.23.39.117/CapacityApps/public/api/getDataBuyer?no_model=' . urlencode($noModel);
    ...
    public function generateOpenPONylon()
    {
        ...
        foreach ($result as &$res) {
            ...
            // API URL dari config
            $apiUrl = 'http://172.23.39.117/CapacityApps/public/api/getDataBuyer?no_model=' . urlencode($res['no_model']);
    ...
    private function buildSisaKebutuhanData(string $area, string $noModel): array
    {
        ...
        foreach ($dataPemesanan as $p) {
            ...
            foreach ($getStyle as $row) {
                $urlQty = 'http://172.23.39.117/CapacityApps/public/api/getQtyOrder?no_model=' . urlencode($p['no_model'])
        ...
        foreach ($dataRetur as $r) {
            ...
            foreach ($getStyle as $row) {
                $urlQty = 'http://172.23.39.117/CapacityApps/public/api/getQtyOrder?no_model=' . urlencode($r['no_model'])
                    . '&style_size=' . urlencode($row['style_size'])
                    . '&area=' . urlencode($area);
