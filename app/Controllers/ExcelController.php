...
class ExcelController extends BaseController
{
    ...
    public function excelPPHNomodel($area, $model)
    {
        ...
        foreach ($models as $items) {
            ...
            $apiUrl  = 'http://192.168.44.14/CapacityApps/public/api/getDataPerinisial/' . $area . '/' . $model . '/' . $styleSize;
    ...
    {
        $apiUrl = 'http://192.168.44.14/CapacityApps/public/api/getPPhPerhari/' . $area . '/' . $tanggal;
    ...
    public function exportDatangBenang()
    {
        ...
        // Header
        $header = ["No", "Foll Up", "No Model", "No Order", "Buyer", "Delivery Awal", "Delivery Akhir", "Order Type", "Item Type", "Kode Warna", "Warna", "KG Pesan", "Tanggal Datang", "Kgs Datang", "Cones Datang", "LOT Datang", "No Surat Jalan", "LMD", "GW", "Harga", "Nama Cluster", "Admin"];
    ...
    public function exportPoBenang()
    {
        ...
        foreach ($data as $index => $item) {
            ...
            $getStartMcUrl = 'http://192.168.44.14/CapacityApps/public/api/getStartMc/' . $model;
    ...
    public function exportGlobalReport()
    {
        ...
        $getDeliv = 'http://192.168.44.14/CapacityApps/public/api/getDeliv/' . $key;
    ...
    public function exportHistoryPindahOrder()
    {
        ...
        $client = \Config\Services::curlrequest([
            'baseURI' => 'http://192.168.44.14/CapacityApps/public/api/',
            'timeout' => 5
        ]);
    ...
    public function generateOpenPOExcel($no_model)
    {
        ...
        $apiUrl = 'http://192.168.44.14/CapacityApps/public/api/getDataBuyer?no_model=' . urlencode($noModel);
        ...
        // $buyerApiUrl = 'http://192.168.44.14/CapacityApps/public/api/getDataBuyer?no_model=' . urlencode($noModel);
    ...
    public function generateOpenPONylon()
    {
        ...
        foreach ($result as &$res) {
            ...
            // API URL dari config
            $apiUrl = 'http://192.168.44.14/CapacityApps/public/api/getDataBuyer?no_model=' . urlencode($res['no_model']);
    ...
    private function buildSisaKebutuhanData(string $area, string $noModel): array
    {
        ...
        foreach ($dataPemesanan as $p) {
            ...
            foreach ($getStyle as $row) {
                $urlQty = 'http://192.168.44.14/CapacityApps/public/api/getQtyOrder?no_model=' . urlencode($p['no_model'])
        ...
        foreach ($dataRetur as $r) {
            ...
            foreach ($getStyle as $row) {
                $urlQty = 'http://192.168.44.14/CapacityApps/public/api/getQtyOrder?no_model=' . urlencode($r['no_model'])
                    . '&style_size=' . urlencode($row['style_size'])
                    . '&area=' . urlencode($area);
