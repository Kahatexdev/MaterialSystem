...
class GodController extends BaseController
{
    ...
    {
        $apiUrl = 'http://172.23.39.116/CapacityApps/public/api/getNoModel';
    ...
    public function poTambahanDetail($noModel, $area)
    {
        ...
        $apiUrl = 'http://172.23.39.116/CapacityApps/public/api/getSisaPerSize/' . $area . '/' . $noModel
        ...
        $bsMesinList = [];
        $apiUrl = 'http://172.23.39.116/CapacityApps/public/api/getBsMesin/' . $area . '/' . $noModel
            . '?styles[]=' . implode('&styles[]=', array_map('urlencode', $styleSize));
        // Mengambil data dari API eksternal
        $response = @file_get_contents($apiUrl);
        ...
        $bsSettingList = [];
        $apiUrl = 'http://172.23.39.116/CapacityApps/public/api/getBsSetting'
            . '?area=' . urlencode($area)
        ...
        $apiUrl = 'http://172.23.39.116/CapacityApps/public/api/getDataBruto'
