...
class ApiController extends ResourceController
{
    ...
    public function getpengaduan()
    {
        ...
        $url      = 'http://192.168.44.14/CapacityApps/public/api/pengaduan/' . $username . '/' . $role;
    ...
    public function pengaduanExport($idPengaduan)
    {
        ...
        $response = $client->get("http://192.168.44.14/CapacityApps/public/api/ExportPengaduan/{$idPengaduan}");
