...
class ApiController extends ResourceController
{
    ...
    public function getpengaduan()
    {
        ...
        $role     = session()->get('role');
        $url      = 'http://172.23.39.116/CapacityApps/public/api/pengaduan/' . $username . '/' . $role;
    ...
    public function pengaduanExport($idPengaduan)
    {
        ...
        $response = $client->get("http://172.23.39.116/CapacityApps/public/api/ExportPengaduan/{$idPengaduan}");
