    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " data-color="info" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse h-auto  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <!-- <li class="nav-item">
                    <a class="nav-link   <?= set_active($active . '/memo') ?>" href="<?= base_url($role . '/memo') ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= set_active($active . '/schedule/reqschedule') ?>" href="<?= base_url($role . '/schedule/reqschedule') ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fas fa-calendar-plus text-dark"></i>
                        </div>
                        <span class="nav-link-text ms-1">Reqschedule</span>
                    </a>
                </li>
                <li class="nav-item">
