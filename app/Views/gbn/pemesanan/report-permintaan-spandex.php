                ...
                <table id="dataTable" class="display text-center text-uppercase text-xs font-bolder" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder">Total JALAN MC</th>
                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder">Total Pesan (KG)</th>
                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder">Total Cones</th>
                        </tr>
                    </thead>
                    <tbody>
...
<script>
    $(document).ready(function() {
        ...
        function loadData() {
            ...
            $.ajax({
                url: "<?= base_url($role . '/pemesanan/getFilterPemesananSpandex') ?>",
                type: "GET",
                data: {
        ...
        $('#btnExport').click(function() {
            let tanggal_awal = $('#tglAwal').val().trim();
            let tanggal_akhir = $('#tglAkhir').val().trim();
            window.location.href = "<?= base_url($role . '/pemesanan/exportPermintaanSpandex') ?>?tanggal_awal=" + tanggal_awal + "&tanggal_akhir=" + tanggal_akhir;
        });
