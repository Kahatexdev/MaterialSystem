...
<script>
    $(document).ready(function() {
        ...
        function loadData() {
            ...
            $.ajax({
                url: "<?= base_url($role . '/pemesanan/getFilterPemesananKaret') ?>",
                type: "GET",
                data: {
        ...
        $('#btnExport').click(function() {
            let tanggal_awal = $('#tglAwal').val().trim();
            let tanggal_akhir = $('#tglAkhir').val().trim();
            window.location.href = "<?= base_url($role . '/pemesanan/exportPermintaanKaret') ?>?tanggal_awal=" + tanggal_awal + "&tanggal_akhir=" + tanggal_akhir;
        });
