...
<div class="container-fluid py-4">
    ...
    <div class="card card-frame">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0 font-weight-bolder">Filter Sisa Datang Benang</h5>
    ...
    <div class="card mt-4">
        <div class="card-body">
            <h5 class="mb-3 font-weight-bolder">Tabel Sisa Datang Benang</h5>
...
<script>
    $(document).ready(function() {
        ...
        function loadData() {
            ...
            $.ajax({
                url: "<?= base_url($role . '/warehouse/reportSisaDatangBenang') ?>",
                type: "GET",
                data: {
                ...
                success: function(response) {
                    ...
                    // ====== HAPUS INSTANCE DATATABLES SEBELUM ISI ULANG ======
                    ...
                    if (response.length > 0) {
                        ...
                        $.each(response, function(index, item) {
                            ...
                            <tr>
                                ...
                                <td>${kgsPlus.toFixed(2)}</td>
                                <td>${gantiRetur.toFixed(2)}</td>
                                <td>${qtyRetur}</td>
                    ...
                    // ====== REINIT DATATABLE SESUDAH ISI DATA ======
        ...
        $('#btnExport').click(function() {
            ...
            const url = "<?= base_url($role . '/warehouse/exportReportSisaDatangBenang') ?>" +
