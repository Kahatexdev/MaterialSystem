                    ...
                    <ul class="navbar-nav justify-content-end">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end px-2 py-3 me-sm-n4 custom-dropdown-wide" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <li><a class="dropdown-item" href="<?= base_url($role . '/warehouse/historyPindahCluster') ?>">Report History Pindah Cluster</a></li>
                                ...
                                <li><a class="dropdown-item" href="<?= base_url($role . '/warehouse/reportHistoryReturCelup') ?>">History Retur Celup</a></li>
                            </ul>
                        </li>
