                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" class="form-control" name="kgs_masuk[]" value="<?= $data['kgs_kirim'] ?>" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="">Cones:</label>
                                                                    <input type="number" class="form-control" name="cns_masuk[]" value="<?= $data['cones_kirim'] ?>" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group d-flex justify-content-end">
