                            ...
                            <tbody>
                                ...
                                <?php foreach ($listBarcode as $list) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?= $list['lot_awal'] ?></td>
                                        <td class="text-center"><a href="<?= base_url($role . '/warehouse/detailPindahOrderBarcode/' . $list['id_stock']) ?>" class="btn btn-info btn-sm">Detail</i></a></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
