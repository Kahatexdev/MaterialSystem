...
<div class="container-fluid py-4">
    ...
    <div class="card card-frame">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0 font-weight-bolder">Filter Sisa Pakai Benang</h5>
    ...
    <div class="card mt-4">
        <div class="card-body">
            <h5 class="mb-3 font-weight-bolder">Tabel Sisa Pakai Benang</h5>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p><strong>Note:</strong> Rumus Sisa Pakai Benang</p>
                <div class="mb-3">
...
<script>
    $(document).ready(function() {
        function loadData() {
            ...
            $.ajax({
                url: "<?= base_url($role . '/warehouse/filterSisaPakaiBenang') ?>",
                type: "GET",
                data: {
