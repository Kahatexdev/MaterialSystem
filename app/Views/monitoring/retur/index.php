...
<div class="container-fluid py-2">
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.btnRetur', function() {
            ...
            $.ajax({
                // url: "http://192.168.1.5/MaterialSystem/public/index.php/api/cekBahanBaku/" + model,
        ...
        //     $.ajax({
        //         // url: "http://192.168.1.5/MaterialSystem/public/index.php/api/listRetur",
        ...
        //     const baseUrl = "http://192.168.1.5/CapacityApps/public/index.php/user/retur/";
        //     tableBody.innerHTML = `
        ...
        function updateItemSelect(data, model) {
            ...
            $.ajax({
                // url: "http://192.168.1.5/MaterialSystem/public/index.php/api/getPengirimanArea?noModel=" + model,
