...
<div class="container-fluid py-2">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            btnSearch.addEventListener('click', function() {
                ...
                $.ajax({
                    url: "http://192.168.1.3/CapacityApps/public/api/filterRetur/" + area,
                    type: "GET",
                    data: {
                        model: model
                    },
        ...
        $(document).on('click', '.btnRetur', function() {
            ...
            $.ajax({
                url: "http://192.168.1.3/MaterialSystem/public/api/cekBahanBaku/" + model,
                type: "GET",
                data: {
                    model: model
                },
        ...
        function listRetur(model, area) {
            ...
            $.ajax({
                url: "http://192.168.1.3/MaterialSystem/public/api/listRetur",
                type: "GET",
                data: {
                    model: model,
                    area: area
        ...
        function fetchListRetur(data, model) {
            ...
            const baseUrl = "http://192.168.1.3/CapacityApps/public/user/retur/";
            tableBody.innerHTML = `
    ...
    `;
        ...
        function updateItemSelect(data, model) {
            ...
            $.ajax({
                url: "http://192.168.1.3/MaterialSystem/public/api/getPengirimanArea?noModel=" + model,
                type: "GET",
                data: {
                    model: model
                },
