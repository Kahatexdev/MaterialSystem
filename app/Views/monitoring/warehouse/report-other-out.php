    ...
    <div class="card card-frame">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0 font-weight-bolder">Filter Pengeluaran Lain-lain</h5>
            </div>
            <div class="row mt-2">
                <div class="col-md-3">
                    <label for="">Key</label>
                ...
                <table id="dataTable" class="display text-center text-uppercase text-xs font-bolder" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder">Kgs Keluar</th>
                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder">Cns Keluar</th>
                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder">Krg Keluar</th>
...
<script>
    $(document).ready(function() {
        ...
        function loadData() {
            ...
            $.ajax({
                url: "<?= base_url($role . '/warehouse/filterOtherOut') ?>",
                type: "GET",
                data: {
                    key: key,
