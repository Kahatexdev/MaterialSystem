        ...
        <div class="col-12 col-lg-10 col-xl-8">
                ...
                <div class="gradient-header text-white p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            ...
                            <h4 class="mb-0 fw-bold text-white">FORM IMPORT PENGELUARAN SEMENTARA</h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body p-4">
                    <form action="<?= base_url($role . '/pengeluaranSementara/upload') ?>" method="post" enctype="multipart/form-data" id="importForm">
                        <!-- File Upload Area -->
                        <div class="mb-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center pt-3">
                            <button type="submit" class="btn btn-gradient text-white px-4 py-2 fw-semibold w-100 btn-lg" id="submitBtn">
                                <span id="submitText">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        $('#importForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '<?= site_url($role . "/pengeluaranSementara/upload") ?>',
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
