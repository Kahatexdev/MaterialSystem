                                                    ...
                                                    <table id="poTable" class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td><input type="float" class="form-control gw_kirim_input" name="gw_kirim[0][0]"></td>
                                                                <td><input type="float" class="form-control kgs_kirim_input" name="kgs_kirim[0][0]"></td>
                                                                <td><input type="float" class="form-control cones_kirim_input" name="cones_kirim[0][0]"></td>
                                                                <td><input type="text" class="form-control lot_kirim_input" name="lot_kirim[0][0]"></td>
