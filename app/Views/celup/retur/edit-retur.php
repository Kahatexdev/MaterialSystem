                ...
                <?php foreach ($uniqueData as $data): ?>
                    <div class="card-header">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <a href="<?= base_url($role . '/retur') ?>" class="btn btn-secondary ms-auto">Back</a>
                        </div>
                        <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url(session('role') . '/proseseditretur/' . $data['id_celup']) ?>" method="post">
                            <div class="row">
                                <div class="col-md-3">
                                    <!-- No Mesin -->
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group" id="ketDailyCekGroup">
                                        <label for="ket_daily_cek">Ket Retur</label>
