                ...
                <?php foreach ($uniqueData as $data): ?>
                    <div class="card-header">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <a href="<?= base_url($role . '/schedule') ?>" class="btn btn-secondary ms-auto">Back</a>
                        </div>
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group" id="tglBonGroup">
                                        ...
                                        <input type="date" class="form-control" name="tgl_bon" id="tgl_bon" value="<?= $data['tgl_bon'] ?>">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <!-- Tanggal Celup -->
                                    <div class="form-group" id="tglCelupGroup">
                                        ...
                                        <input type="date" class="form-control" name="tgl_celup" id="tgl_celup" value="<?= $data['tgl_celup'] ?>">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <!-- Tanggal Bongkar -->
                                    <div class="form-group" id="tglBongkarGroup">
                                        ...
                                        <input type="date" class="form-control" name="tgl_bongkar" id="tgl_bongkar" value="<?= $data['tgl_bongkar'] ?>">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <!-- Tanggal Press -->
                                    <div class="form-group" id="tglPressGroup">
                                        ...
                                        <input type="date" class="form-control" name="tgl_press" id="tgl_press" value="<?= $data['tgl_press'] ?>">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <!-- Tanggal Oven -->
                                    <div class="form-group" id="tglOvenGroup">
                                        ...
                                        <input type="date" class="form-control" name="tgl_oven" id="tgl_oven" value="<?= $data['tgl_oven'] ?>">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <!-- Tanggal Rajut Pagi -->
                                    <div class="form-group" id="tglRajutGroup">
                                        ...
                                        <input type="date" class="form-control" name="tgl_rajut" id="tgl_rajut" value="<?= $data['tgl_oven'] ?>">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <!-- Tanggal ACC -->
                                    <div class="form-group" id="tglACCGroup">
                                        ...
                                        <input type="date" class="form-control" name="tgl_acc" id="tgl_acc" value="<?= $data['tgl_acc'] ?>">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <!-- Tanggal Kelos -->
                                    <div class="form-group" id="tglKelosGroup">
                                        ...
                                        <input type="date" class="form-control" name="tgl_kelos" id="tgl_kelos" value="<?= $data['tgl_kelos'] ?>">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <!-- Tanggal Reject -->
                                    <div class="form-group" id="tglRejectGroup">
                                        ...
                                        <input type="date" class="form-control" name="tgl_reject" id="tgl_reject" value="<?= $data['tgl_reject'] ?>">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <!-- Tanggal Perbaikan -->
                                    <div class="form-group" id="tglPBGroup">
                                        ...
                                        <input type="date" class="form-control" name="tgl_pb" id="tgl_pb" value="<?= $data['tgl_pb'] ?>">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <!-- Ket Daily Cek -->
