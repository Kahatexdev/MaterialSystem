                    ...
                    <div class="row">
                        <form action="<?= base_url(session('role') . '/schedule/updateSchedule') ?>" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select name="lot_urut" id="lot_urut" class="form-select" readonly>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="jenis_bahan_bakuE" name="jenis_bahan_baku" required readonly>
                            ...
                            <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-select item-type" name="item_type[]" required disabled>
                                                                ...
                                                                <div class="col-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-select po-select" name="po[]" required disabled>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="date" class="form-control" name="tgl_start_mc[]" value="<?= $detail['start_mc'] ?>" required readonly>
                                                                    </div>
                                                                </div>
                                                                <div class="col-4">
                                                                    <div class="form-group">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <fieldset>
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <input type="radio" id="po_plus_yes_<?= $key ?>" name="po_plus[<?= $key ?>]" value="1" <?= ($val === '1') ? 'checked' : '' ?> readonly>
                                                                                <label for="po_plus_yes_<?= $key ?>">Iya</label>
                                                                                <input type="radio" id="po_plus_no_<?= $key ?>" name="po_plus[<?= $key ?>]" value="0" <?= ($val === '0' || $val === '') ? 'checked' : '' ?> readonly>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <br />
                                                                        <textarea class="form-control ket_schedule[]" name="ket_schedule[]" id="ket_schedule" readonly><?= $detail['ket_schedule'] ?></textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="col-12">
                                ...
                                <div class="text-end">
                                    <button type="submit" class="btn btn-info w-100" disabled>Update Jadwal</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function fetchItemTypeRow(kodeWarna, warna, itemTypeSelect) {
            console.log("Fetching item type for kode_warna:", kodeWarna, "warna:", warna);
