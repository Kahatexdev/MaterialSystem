...
class PemasukanModel extends Model
{
    ...
    {
        return $this->select('
                COALESCE(schedule_celup.no_model, retur.no_model, other_bon.no_model) AS no_model,
                COALESCE(schedule_celup.item_type, retur.item_type, other_bon.item_type) AS item_type,
                COALESCE(schedule_celup.kode_warna, retur.kode_warna, other_bon.kode_warna) AS kode_warna,
                COALESCE(schedule_celup.warna, retur.warna, other_bon.warna) AS warna,
                pemasukan.*,
                out_celup.no_karung, out_celup.lot_kirim, out_celup.kgs_kirim, out_celup.cones_kirim,
