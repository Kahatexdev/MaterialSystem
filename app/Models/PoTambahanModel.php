...
class PoTambahanModel extends Model
{
    ...
    {
        $builder = $this->select('po_tambahan.*, total_potambahan.ttl_sisa_bb_dimc, master_order.no_model, master_order.delivery_akhir, material.item_type, material.kode_warna, material.color, material.style_size, material.kgs, material.composition, material.gw, material.qty_pcs, material.loss')
