...
class OtherBonModel extends Model
{
    ...
    protected $allowedFields    = ['id_other_bon', 'no_model', 'item_type', 'kode_warna', 'warna', 'tgl_datang', 'no_surat_jalan', 'detail_sj', 'keterangan', 'ganti_retur', 'po_tambahan', 'admin', 'created_at', 'update_at'];
